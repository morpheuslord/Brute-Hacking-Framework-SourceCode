...
nano="%CMDER_ROOT%\vendor\git-for-windows\usr\bin\nano.exe" $*
nmap="%CMDER_ROOT%\bin\brute-framework\BF_Files\nmap\nmap.exe" $*
ncat="%CMDER_ROOT%\bin\brute-framework\BF_Files\nmap\ncat.exe" $*
hydra="%CMDER_ROOT%\bin\brute-framework\BF_Files\thc-hydra-windows\hydra.exe" $*
